...
import myapp.schedule.misha.myapplication.module.schedule.edit.page.dialogCopy.CopyFragmentAdapter;
...
public class CreateLessonFragment extends BaseMainFragment implements CreateLessonView,
    ...
    public void copyLesson() {
        if (listLessonsForCopy.isEmpty()) {
            ...
            Lesson currentLesson = getArguments().getParcelable(CreateLessonView.CURRENT_LESSON);
    ...
    public void onActivityResult(int requestCode, int resultOk, Intent data) {
        if (requestCode == CreateLessonView.LESSON) {
